...
class LoginPage2(tk.Toplevel):
    def __init__(self, system_username):
        ...
        self.clock_in_time = datetime.now().strftime("%Y-%m-%d %H:%M:%S")  # Record the clock-in time
        ...
        self.update_time()  # Update the time label initially
        self.after(1000, self.update_time)  # Schedule the periodic update of time
        ...
        self.saved_data = []  # List to store the saved data

        # Add validation functions to enforce input restrictions
    ...
    def update_time(self):
        ...
        self.after(1000, self.update_time)  # Schedule the next update after 1 second
    ...
    def save_data(self):
        ...
        # Store the saved data as a dictionary
        ...
        # Set the font size for the message label
    ...
    def view_data(self):
        if self.saved_data:
            # Create a new window for displaying data and search functionality
            ...
            # Display the saved data in the data text widget
            ...
            # Show a message if no data has been saved
